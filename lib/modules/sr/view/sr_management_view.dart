...
class SrManagementView extends GetView<SrManagementController> {
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'নাম বা ফোন দিয়ে খুঁজুন…'.tr,
  ...
  Future<void> _showAddEditDialog(
    ...
    await Get.dialog(
      AlertDialog(
        title: Text(isNew ? 'নতুন SR যোগ করুন'.tr : 'SR সম্পাদনা'.tr),
            ...
            child: Column(
              ...
              children: [
                _field(
                  ...
                  'নাম *'.tr,
                  validator: (v) =>
                      v == null || v.isEmpty ? 'নাম লিখুন'.tr : null,
                ),
                ...
                _field(
                  ...
                  validator: (v) =>
                      v == null || v.isEmpty ? 'ফোন নং লিখুন'.tr : null,
                ),
                const SizedBox(height: 10),
                _field(
                  emailCtrl,
                  'ইমেইল (লগইনের জন্য) *'.tr,
                  keyboard: TextInputType.emailAddress,
                  readOnly: !isNew, // email can't be changed after creation
                  validator: (v) {
                    if (v == null || v.isEmpty) return 'ইমেইল আবশ্যক'.tr;
                    if (!GetUtils.isEmail(v)) return 'সঠিক ইমেইল দিন'.tr;
                    return null;
                  },
                ),
                const SizedBox(height: 10),
                _field(
                  ...
                  validator: (v) =>
                      v == null || v.isEmpty ? 'বেতন লিখুন'.tr : null,
                ),
                const SizedBox(height: 10),
                _field(
                  commCtrl,
                  ...
                  validator: (v) =>
                      v == null || v.isEmpty ? 'কমিশন % লিখুন'.tr : null,
                ),
                const SizedBox(height: 10),
                _field(
                  dueLimitCtrl,
                  ...
                  keyboard: TextInputType.number,
                  validator: (v) =>
                      v == null || v.isEmpty ? 'বাকি লিমিট লিখুন'.tr : null,
                ),
                if (isNew) ...[
                  ...
                  Obx(
                    () => TextFormField(
                      ...
                      validator: (v) {
                        if (v == null || v.isEmpty) {
                          return 'পাসওয়ার্ড দিন'.tr;
                        }
                        if (v.length < 6) {
                          return 'কমপক্ষে ৬ অক্ষর'.tr;
                        }
                        return null;
                      },
                    ),
                  ...
                  Obx(
                    () => TextFormField(
                      ...
                      obscureText: !showPass.value,
                      decoration: InputDecoration(
                        labelText: 'পাসওয়ার্ড নিশ্চিত করুন *'.tr,
                        border: OutlineInputBorder(),
                        isDense: true,
                      ),
                      validator: (v) {
                        if (v != passwordCtrl.text) {
                          return 'পাসওয়ার্ড মিলছে না'.tr;
                        }
                        return null;
                      },
                    ),
              ...
              onPressed: saving.value
                  ...
                  : () async {
                      ...
                      final data = {
                        ...
                        'dueLimit': double.tryParse(dueLimitCtrl.text) ?? 60000,
                        'isActive': isActive.value,
                      };
                      Get.back();
                      if (isNew) {
                        await controller.addSr(
                          data,
...
class _SrCard extends StatelessWidget {
  ...
  const _SrCard({required this.sr, required this.scheme, required this.fmt});
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      sr.isActive ? 'সক্রিয়'.tr : 'নিষ্ক্রিয়'.tr,
                      style: TextStyle(
                        color: sr.isActive ? Colors.green : Colors.grey,
                        fontWeight: FontWeight.w700,
                        fontSize: 11,
              ...
              Wrap(
                ...
                children: [
                  _chip(
                    Icons.badge_rounded,
                    '${'বেতন'.tr}: ৳${fmt.format(sr.monthlyFixedSalary.toInt())}',
                    scheme,
                  ),
                  _chip(
                    Icons.percent_rounded,
                    '${'কমিশন'.tr}: ${sr.commissionPercent}%',
                    scheme,
                  ),
                  _chip(
                    Icons.warning_amber_rounded,
                    '${'বাকি লিমিট'.tr}: ৳${fmt.format(sr.dueLimit.toInt())}',
                    scheme,
                  ),
                  _chip(
                    Icons.store_rounded,
                    '${sr.assignedShopIds.length} ${'দোকান'.tr}',
                    scheme,
                  ),
                  _chip(
                    Icons.phone_rounded,
                    '${sr.callContactIds.length} ${'কন্টাক্ট'.tr}',
                    scheme,
                  ),
                  _chip(
                    sr.uid.isNotEmpty
                    ...
                    sr.uid.isNotEmpty ? 'লগইন আছে'.tr : 'লগইন নেই'.tr,
                    scheme,
              ...
              const SizedBox(height: 12),
              // Action buttons — সরু স্ক্রিনে এক সারিতে ধরে না, তাই Wrap
              Wrap(
                ...
                children: [
                  ...
                  TextButton.icon(
                    ...
                    label: Text(sr.isActive ? 'নিষ্ক্রিয়'.tr : 'সক্রিয়'.tr),
                  ...
                  TextButton.icon(
                    onPressed: () => _confirmDelete(context, ctrl, sr),
  ...
  Widget _chip(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: color != null ? Border.all(color: color.withAlpha(80)) : null,
      ),
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
  ...
  Future<void> _showAddEditDialog(
    ...
    final commCtrl = TextEditingController(
      text: sr.commissionPercent.toString(),
    );
    final dueLimitCtrl = TextEditingController(
      text: sr.dueLimit.toInt().toString(),
    );
            ...
            child: Column(
              ...
              children: [
                ...
                _formField(
                  ...
                  validator: (v) => v == null || v.isEmpty ? 'লিখুন'.tr : null,
                ),
                const SizedBox(height: 10),
                _formField(
                  dueLimitCtrl,
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              await ctrl.updateSr(sr.id, {
                ...
                'dueLimit': double.tryParse(dueLimitCtrl.text) ?? sr.dueLimit,
                'isActive': isActive.value,
              });
            },
  ...
  Future<void> _showPasswordResetDialog(
    ...
    await Get.dialog(
      AlertDialog(
        title: Text('${'পাসওয়ার্ড রিসেট'.tr} — ${sr.name}'),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(
              '${sr.email} ${'ঠিকানায় একটি পাসওয়ার্ড রিসেট লিংক পাঠানো হবে'.tr}।\n\nSR ${'সেই লিংক ব্যবহার করে নতুন পাসওয়ার্ড সেট করতে পারবে'.tr}।',
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'এই SR এর Firebase অ্যাকাউন্ট এখনো তৈরি হয়নি।'.tr,
        ...
        actions: [
          ...
          ElevatedButton.icon(
            onPressed: sr.uid.isEmpty || sr.email.isEmpty
                ...
                : () async {
                    Get.back();
                    await ctrl.resetSrPassword(sr: sr, newPassword: '');
                  },
            icon: const Icon(Icons.send_rounded, size: 16),
            label: Text('লিংক পাঠান'.tr),
  ...
  Future<void> _confirmDelete(
    ...
    final ok = await Get.dialog<bool>(
      AlertDialog(
        title: Text('SR মুছবেন?'.tr),
        content: Text('${sr.name} — এই SR-${'এর সমস্ত তথ্য মুছে যাবে'.tr}।'),
        actions: [
          TextButton(
          ...
          TextButton(
            ...
            child: Text('হ্যাঁ, মুছুন'.tr, style: TextStyle(color: Colors.red)),
          ),
        ],
      ),
    );
