...
class _SrDetailViewState extends State<SrDetailView>
  ...
  SrModel get sr => ctrl.srList.firstWhere(
    (s) => s.id == _srId,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(sr.name, style: TextStyle(fontWeight: FontWeight.w800)),
        actions: [IconButton(icon: Icon(Icons.refresh), onPressed: _loadMonth)],
        bottom: TabBar(
          controller: _tabs,
          tabs: [
        ...
        child: ListView(
          ...
          children: [
            ...
            if (s == null) ...[
              ...
              // Due & frozen alert
              if (s.totalDueFromCustomers > 0) _dueAlert(s, scheme),
              const SizedBox(height: 14),
  ...
  Widget _kpiGrid(BuildContext context, SrMonthStats s, ColorScheme scheme) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _dueRow(
            'মোট গ্রাহক বাকি'.tr,
            '৳ ${_fmt.format(s.totalDueFromCustomers.toInt())}',
            scheme,
          ),
          _dueRow(
            'বাকি লিমিট'.tr,
            '৳ ${_fmt.format(sr.dueLimit.toInt())}',
            scheme,
          ),
          if (overLimit) ...[
  ...
  Future<void> _showPaymentDialog(BuildContext context, SrMonthStats s) async {
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      '${'বাকি'.tr}: ৳${_fmt.format(s.balance.toInt())}',
                    ...
                    Text(
                      '${'নেট প্রদেয়'.tr}: ৳${_fmt.format(s.netPayable.toInt())}',
                      style: const TextStyle(
                        fontSize: 13,
                        fontWeight: FontWeight.w700,
                        color: Colors.orange,
                    ...
                    ...() {
                      ...
                      if (day == null || day.isEmpty)
                        return <Widget>[
                          ...
                          GestureDetector(
                            onTap: () => _showDayPickerForExisting(
                              context,
                              scheme,
                              u.id,
  ...
  Widget _visitBadge(String status) {
    final label = _visitStatuses
        .firstWhere((e) => e.$1 == status, orElse: () => (status, status))
        .$2;
      ...
      AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            ListTile(
              dense: true,
              leading: Icon(Icons.clear_rounded, size: 18, color: scheme.error),
              title: Text(
                'ডেলিভারি দিন সরান'.tr,
  ...
  Future<void> _removeAssignment(UserModel u, {required bool isCall}) async {
    if (isCall) {
      final updated = List<String>.from(sr.callContactIds)..remove(u.id);
      await ctrl.updateAssignments(sr.id, callIds: updated);
    } else {
      final updated = List<String>.from(sr.assignedShopIds)..remove(u.id);
                          ...
                          : Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                    '${selected.length}${'টি দোকান নির্বাচিত'.tr}',
                                    style: TextStyle(
                                      fontSize: 12,
                                      fontWeight: FontWeight.w600,
                                      color: scheme.primary,
                          ...
                          .where(
                            (u) =>
                                ...
                                (q.isEmpty ||
                                    ...
                                    u.proprietorName.toLowerCase().contains(
                                      q,
                                    ) ||
                                    u.phone.contains(q)),
                          )
                  ...
                  () => ElevatedButton.icon(
                    onPressed: selected.isEmpty
                        ...
                        : () async {
                            ...
                            Get.back();
                            final updated =
                                List<String>.from(sr.assignedShopIds)..addAll(
                                  ids.where(
                                    (id) => !sr.assignedShopIds.contains(id),
                                  ),
                                );
                            await ctrl.updateAssignments(
                              sr.id,
