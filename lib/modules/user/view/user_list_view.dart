      ...
      body: ResponsiveWrapper(
        child: Column(
          children: [
            ...
            Obx(() {
              final totalDue = controller.users.fold<int>(
                0,
                (sum, u) => sum + u.totalDue,
              );
              final dueCount = controller.users
                  .where((u) => u.totalDue > 0)
                  .length;
                                    ...
                                    if (v == 'details') {
                                      ...
                                      final confirmed = await Get.dialog<bool>(
                                        AlertDialog(
                                          ...
                                          content: Text(
                                            '${user.shopName} কে $action ${'করতে চান'.tr}?',
                                          ),
                                          actions: [
                                            TextButton(
                                              onPressed: () =>
