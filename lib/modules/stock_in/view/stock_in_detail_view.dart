    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Column(
          ...
          children: [
            Text(
              dateFmt.format(widget.group.date),
                  ...
                  Row(
                    children: [
                      ...
                      if (entry.unitPrice > 0)
                        Text(
                          '৳${_fmt.format(entry.unitPrice.toInt())}/pc',
                          style: TextStyle(
                            fontSize: 12,
                            color: scheme.onSurface.withAlpha(140),
                          ),
            ...
            Column(
              ...
              children: [
                if (entry.totalPrice > 0)
                  Text(
                    '৳${_fmt.format(entry.totalPrice.toInt())}',
                    style: const TextStyle(
                      fontSize: 15,
                      fontWeight: FontWeight.w800,
                      color: Color(0xFF16A34A),
          ...
          content: Column(
            ...
            children: [
              ...
              Align(
                ...
                child: Text(
                  '${'মোট'.tr}: ৳${_fmt.format(((num.tryParse(priceCtrl.text) ?? 0) * (int.tryParse(qtyCtrl.text) ?? 0)).toInt())}',
                  style: const TextStyle(
                    fontSize: 14,
                    fontWeight: FontWeight.w800,
                    color: Color(0xFF16A34A),
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            'প্রডাক্ট যোগ করুন'.tr,
                            style: Theme.of(ctx).textTheme.titleMedium
                                ?.copyWith(fontWeight: FontWeight.w800),
                          ),
                        ),
                        Text(
                          DateFormat('dd MMM').format(widget.group.date),
                          style: TextStyle(
                            fontSize: 12,
                        ...
                        : ListView.separated(
                            ...
                            itemBuilder: (_, i) {
                              ...
                              return ListTile(
                                ...
                                subtitle: Text(
                                  '${'স্টক'.tr}: ${p.stock} | ৳${_fmt.format(p.purchasePrice)}',
                                  style: TextStyle(
                                    fontSize: 11,
                                    color: scheme.onSurface.withAlpha(120),
                                  ),
