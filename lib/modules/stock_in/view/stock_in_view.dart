...
class _StockInViewState extends State<StockInView> {
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: 'প্রডাক্ট নাম, সোর্স বা নোট দিয়ে খুঁজুন…'.tr,
        ...
        child: Row(
          children: [
            ...
            Column(
              ...
              children: [
                Text(
                  '${controller.totalEntries} ${'এন্ট্রি'.tr}',
                  style: const TextStyle(
                    fontSize: 12,
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 4),
                            Text(
                              '${group.entries.length} ${'প্রডাক্ট'.tr} • ${group.totalQty} pcs',
                              style: TextStyle(
                                fontSize: 13,
                                fontWeight: FontWeight.w600,
                            ...
                            child: Column(
                              children: [
                                ...
                                TextField(
                                  controller: noteCtrl,
                                  decoration: InputDecoration(
                                    hintText: 'কোনো নোট থাকলে লিখুন'.tr,
                                    filled: true,
                                    fillColor: scheme.surfaceContainerHigh,
                                    border: OutlineInputBorder(
                                  ...
                                  children: [
                                    ...
                                    Obx(
                                      () => selectedItems.isEmpty
                                          ...
                                          : Text(
                                              '${selectedItems.length} ${'টি'.tr} | ${totalQty()} pcs | ৳${_fmt.format(totalValue().toInt())}',
                                              style: const TextStyle(
                                                fontSize: 12,
                                                color: Color(0xFF16A34A),
                                                fontWeight: FontWeight.w600,
                                ...
                                Obx(() {
                                  if (selectedItems.isEmpty) {
                                    return Padding(
                                      ...
                                      child: Center(
                                        child: Text(
                                          'কোনো প্রডাক্ট যোগ করা হয়নি'.tr,
                                          style: TextStyle(
                                  ...
                                  return Column(
                                    children: selectedItems.asMap().entries.map((
                                      e,
                                    ) {
                                      final idx = e.key;
                                      final item = e.value;
                            ...
                            child: ElevatedButton.icon(
                              onPressed: canSubmit
                                  ? () async {
                                      ...
                                      Get.snackbar(
                                        'সফল'.tr,
                                        '${selectedItems.length} ${'টি প্রডাক্ট'.tr}, ${totalQty()} pcs ${'স্টক ইন হয়েছে'.tr}',
                                        snackPosition: SnackPosition.BOTTOM,
                              ...
                              label: Text(
                                submitting
                                    ? 'সাবমিট হচ্ছে…'.tr
                                    : '${'স্টক ইন করুন'.tr} (${totalQty()} pcs | ৳${_fmt.format(totalValue().toInt())})',
                              ),
  ...
  void _showProductPicker(
    BuildContext ctx,
    ColorScheme scheme,
    RxList<_CartItem> selectedItems,
  ) {
    String query = '';
                  ...
                  Expanded(
                    child: displayed.isEmpty
                        ...
                        : ListView.separated(
                            ...
                            itemBuilder: (_, i) {
                              final p = displayed[i];
                              final already = selectedItems.any(
                                (e) => e.id == p.id,
                              );
                              return ListTile(
                                leading: ClipRRect(
                                ...
                                subtitle: Text(
                                  '${'স্টক'.tr}: ${p.stock} | ৳${_fmt.format(p.wholesalePrice)}',
                                  style: TextStyle(
                                    fontSize: 11,
                                    color: scheme.onSurface.withAlpha(120),
                                  ),
  ...
  Widget _dateChip(String label, DateTime? from, DateTime? to) {
    return Obx(() {
      final active =
          controller.fromDate.value == from && controller.toDate.value == to;
      return ChoiceChip(
        label: Text(
          label,
          style: TextStyle(
  ...
  Widget _activeFilterChips(ColorScheme scheme) {
    return Obx(() {
      ...
      if (controller.selectedProductId.value.isNotEmpty) {
        chips.add(
          _chip(controller.selectedProductName.value, () {
      ...
      return Container(
        ...
        child: Row(
          children: [
            ...
            Text(
              '$totalQty pcs • ${filtered.length} ${'এন্ট্রি'.tr}',
              style: const TextStyle(
                fontSize: 11,
                color: Color(0xFF16A34A),
                fontWeight: FontWeight.w600,
